// output_image_dlg.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(COutputImageDlg, CDialog)

COutputImageDlg::COutputImageDlg(CWnd* pParent /*=NULL*/)
	: CDialog(COutputImageDlg::IDD, pParent)
    , m_OutputId1(0)
    , m_OutputId2(0)
    , m_OutputId3(0)
    , m_OutputId4(0)
...
COutputImageDlg::~COutputImageDlg()
{
}

void COutputImageDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(COutputImageDlg, CDialog)
END_MESSAGE_MAP()


// COutputImageDlg message handlers
