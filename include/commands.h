...
DEFINE_COMMAND(LOGOUT_COMMAND)
DEFINE_COMMAND(REGISTER_COMMAND)
DEFINE_COMMAND(SEND_MODEL_FILE_COMMAND)
DEFINE_COMMAND(UPLOAD_FILE_COMMAND)
DEFINE_COMMAND(GET_FILE_LIST_COMMAND)
DEFINE_COMMAND(DOWNLOAD_FILE_COMMAND)
DEFINE_COMMAND(EXIT_COMMAND)
DEFINE_COMMAND(EVALUATE_COMMAND)
