...
DEFINE_ERROR(PLATFORM_LOADDLL_ERROR, "Platform load dll error.")
DEFINE_ERROR(PLATFORM_REGISTERCOMPONENTINFO_ERROR, "Platform register component error.")
DEFINE_ERROR(PLATFORM_REGISTERALGORITHM_ERROR, "Platform register algorithm error.")
DEFINE_ERROR(PLATFORM_REGISTERGETCOMPONENTLISTFUNC_ERROR, "Platform register GetComponentList function error.")
DEFINE_ERROR(PLATFORM_VALIDATEMODEL_ERROR, "Platform validate model error.")
DEFINE_ERROR(PLATFORM_RUNMODEL_ERROR, "Platform run model error.")
DEFINE_ERROR(PLATFORM_UNLOADDLL_ERROR, "Platform unload dll error.")
