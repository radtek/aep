...
DEFINE_ERROR(PLATFORM_LOADDLL_ERROR, "Component load dll error.")
DEFINE_ERROR(PLATFORM_REGISTERCLIENTCOMPONENT_ERROR, "Component register client component error.")
